...
* `cox-media-technology-htb.js` - This is your partner module file, by default it contains a template divided into multiple sections which need to be completed.
* `cox-media-technology-htb-validator.js` - This is the validator file for the configuration object that will be passed into your module.
* `cox-media-technology-htb-exports.js` - A file that contains all of the modules exports (i.e. any functions that need to be exposed to the outside world).

## <a name='gettingStarted'></a>Getting Started
1. <b>Complete the cox-media-technology-htb.js file</b>
    * cox-media-technology-htb.js is where all of your adapter code will live.
...
2. <b>Complete the cox-media-technology-htb-validator.js file</b>
...
3. <b>Complete the cox-media-technology-htb-exports.js file</b>
    * This file will contain any functions that need to be exported or exposed to the outside world. Things like render functions, custom callbacks, etc. Any legacy render functions will also need to be exposed here. Anything added to the `shellInterface.CoxMediaTechnologyHtb` will be accessible through `window.headertag.CoxMediaTechnologyHtb`
...
In this section you will be filling out the cox-media-technology-htb.js, cox-media-technology-htb-exports.js, and the cox-media-technology-htb-validator.js files to create your module.

### Step 0: Config Validation (`cox-media-technology-htb-validator.js`)
...
### Step 2: Generate Request URL (`cox-media-technology-htb.js`)
...
### Step 3: Response Callback (`cox-media-technology-htb.js`)
...
### Step 4: Parsing and Storing Demand (`cox-media-technology-htb.js`)
...
```javascript
{
    ...
    "targetingType": "slot"
    "targeting" : {
        "ix_comet_id": ["_230l09jd2"],
        "ix_comet_cpm": ["300x250_2.50"]
    },
    "price": 2.50,
    "size": [300,250],
...
### Step 5: Rendering Pixel (`cox-media-technology-htb.js`)
...
### Step 6: Exports (`cox-media-technology-htb-exports.js`)
...
```javascript
shellInterface.CoxMediaTechnologyHtb = { //shell interface is the window variable that is accessible through the window object, currently this will always be window.headertag
    render: SpaceCamp.services.RenderService.renderDfpAd.bind(null, 'CoxMediaTechnologyHtb')
};
```
...
```javascript
if (__directInterface.Layers.PartnersLayer.Partners.CoxMediaTechnologyHtb) {
    shellInterface.CoxMediaTechnologyHtb = shellInterface.CoxMediaTechnologyHtb || {};
    shellInterface.CoxMediaTechnologyHtb.adResponseCallback = __directInterface.Layers.PartnersLayer.Partners.CoxMediaTechnologyHtb.adResponseCallback;
}
```
...
if (__directInterface.Layers.PartnersLayer.Partners.CoxMediaTechnologyHtb) {
    shellInterface.CoxMediaTechnologyHtb = shellInterface.CoxMediaTechnologyHtb || {};
    shellInterface.CoxMediaTechnologyHtb.adResponseCallbacks = __directInterface.Layers.PartnersLayer.Partners.CoxMediaTechnologyHtb.adResponseCallbacks;
}
```
