...
var PartnerSpecificValidator = require('cox-media-technology-htb-validator.js');
 ...
 * @class
 */
function CoxMediaTechnologyHtb(configs) {
    /* =====================================
     * Data
     * ---------------------------------- */
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'CoxMediaTechnologyHtb',
            namespace: 'CoxMediaTechnologyHtb',
            statsId: 'COMET',
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
    ...
    var derivedClass = {
        ...
        //? if (DEBUG) {
        __type__: 'CoxMediaTechnologyHtb',
        //? }
...
module.exports = CoxMediaTechnologyHtb;
